	...
	<view :style='{"width":"100%","padding":"0 0 0 0","position":"relative","background":"#ffffff","height":"100%"}'>
		<form :style='{"width":"100%","padding":"24rpx 24rpx 24rpx 24rpx","background":"#ffffff","display":"block","height":"auto"}' class="app-update-pv">
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#eeeeee","alignItems":"center","borderWidth":"0px 0px 2rpx 0px","background":"none","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333333","textAlign":"right"}' class="title">等级名称</view>
				<input :style='{"border":"0px solid #eeeeee","padding":"0px 24rpx 0px 24rpx","margin":"0 0 0 0","color":"#666666","borderRadius":"8rpx","flex":"1","background":"#ffffff00","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' :disabled="ro.dengjimingcheng" v-model="ruleForm.dengjimingcheng" placeholder="等级名称"></input>
			</view>
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#eeeeee","alignItems":"center","borderWidth":"0px 0px 2rpx 0px","background":"none","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333333","textAlign":"right"}' class="title">标准名称</view>
				<input :style='{"border":"0px solid #eeeeee","padding":"0px 24rpx 0px 24rpx","margin":"0 0 0 0","color":"#666666","borderRadius":"8rpx","flex":"1","background":"#ffffff00","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' :disabled="ro.biaozhunmingcheng" v-model="ruleForm.biaozhunmingcheng" placeholder="标准名称"></input>
			</view>
			...
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#eeeeee","alignItems":"center","borderWidth":"0px 0px 2rpx 0px","background":"none","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333333","textAlign":"right"}' class="title">标准说明</view>
				<textarea :style='{"border":"0px solid #eeeeee","padding":"24rpx 24rpx 24rpx 24rpx","margin":"0 0 0 0","color":"#000000","borderRadius":"8rpx","flex":"1","background":"none","fontSize":"28rpx","height":"240rpx"}' v-model="ruleForm.biaozhunshuoming" placeholder="标准说明"></textarea>
			</view>
	...
	export default {
		data() {
			return {
				...
				user: {},
                ro:{
                   dengjimingcheng : false,
                   biaozhunmingcheng : false,
                   tupian : false,
                   biaozhunshuoming : false,
                },
			}
		},
		components: {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`yingyangdengjibiaozhun`, this.ruleForm.id);
			...
			if(options.cross){
				...
				for (var o in obj){
					if(o=='dengjimingcheng'){
					this.ruleForm.dengjimingcheng = obj[o];
					this.ro.dengjimingcheng = true;
					continue;
					}
					if(o=='biaozhunmingcheng'){
					this.ruleForm.biaozhunmingcheng = obj[o];
					this.ro.biaozhunmingcheng = true;
					continue;
					}
					if(o=='tupian'){
					...
					if(o=='biaozhunshuoming'){
					this.ruleForm.biaozhunshuoming = obj[o];
					this.ro.biaozhunshuoming = true;
					continue;
					}
				}
			}
...
//跨表计算判断
				...
				if(crossrefid && crossuserid) {
					...
					let res = await this.$api.list(`yingyangdengjibiaozhun`, params);
                ...
                //跨表计算
						if(this.ruleForm.id){
							await this.$api.update(`yingyangdengjibiaozhun`, this.ruleForm);
						}else{
							await this.$api.add(`yingyangdengjibiaozhun`, this.ruleForm);
						}
